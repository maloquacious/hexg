...
//}
//
//func (l VerticalOddQLayout) HexagonalGrid(center Hex, radius int) HashTable {
//	gs := HashTable{}
//	N := radius
//	for q := -N; q <= N; q++ {
//		r1 := max(-N, -q-N)
...
//}
//
//func (l VerticalOddQLayout) ParallelogramGrid(q1, r1, q2, r2 int) HashTable {
//	gs := HashTable{}
//	for q := q1; q <= q2; q++ {
//		for r := r1; r <= r2; r++ {
...
//}
//
//func (l VerticalOddQLayout) RectangularGrid(center Hex, left, right, top, bottom int) HashTable {
//	gs := HashTable{}
...
//}
//
//func (l VerticalOddQLayout) TriagonalGrid(side_length int) HashTable {
//	gs := HashTable{}
